...
use Coipeault\CN\MegapolisBundle\Entity\Wishlist;
use Coipeault\CN\MegapolisBundle\Form\WishlistType;
...
class WishlistController extends Controller {
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('CoipeaultCNMegapolisBundle:Wishlist')->findAll();
     ...
     *
     * @Route("/", name="wishlist_create")
     * @Method("POST")
     * @Template("CoipeaultCNMegapolisBundle:Wishlist:new.html.twig")
     */
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('CoipeaultCNMegapolisBundle:Wishlist')->find($id);
     ...
     *
     * @Route("/{id}", name="wishlist_update")
     * @Method("PUT")
     * @Template("CoipeaultCNMegapolisBundle:Wishlist:edit.html.twig")
     */
