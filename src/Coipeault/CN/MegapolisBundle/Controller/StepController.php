...
use Coipeault\CN\MegapolisBundle\Entity\Step;
use Coipeault\CN\MegapolisBundle\Form\StepType;
...
class StepController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CoipeaultCNMegapolisBundle:Step')->findAll();
     ...
     * @Method("POST")
     * @Template("CoipeaultCNMegapolisBundle:Step:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CoipeaultCNMegapolisBundle:Step')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CoipeaultCNMegapolisBundle:Step:edit.html.twig")
     */
