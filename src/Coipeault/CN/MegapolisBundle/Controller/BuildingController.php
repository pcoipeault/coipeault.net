...
use Coipeault\CN\MegapolisBundle\Entity\Building;
use Coipeault\CN\MegapolisBundle\Form\BuildingType;
...
class BuildingController extends Controller {
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('CoipeaultCNMegapolisBundle:Building')->findAll();
     ...
     *
     * @Route("/", name="building_create")
     * @Method("POST")
     * @Template("CoipeaultCNMegapolisBundle:Building:new.html.twig")
     */
    public function createAction(Request $request) {
        ...
        if ($form->isValid()) {
            ...
            $nextAction = $form->get('saveAndAdd')->isClicked() ? 'building_new' : 'building_show';
            $reference = ($nextAction == 'building_show') ? array('id' => $entity->getId()) : array();
     ...
     *
     * @Route("/{id}", name="building_update")
     * @Method("PUT")
     * @Template("CoipeaultCNMegapolisBundle:Building:edit.html.twig")
     */
