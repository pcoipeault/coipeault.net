...
use Coipeault\CN\MegapolisBundle\Entity\Stock;
use Coipeault\CN\MegapolisBundle\Form\StockType;
...
class StockController extends Controller {
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('CoipeaultCNMegapolisBundle:Stock')->findAll();
     ...
     * @Method("POST")
     * @Template("CoipeaultCNMegapolisBundle:Stock:new.html.twig")
     */
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('CoipeaultCNMegapolisBundle:Stock')->find($id);
     ...
     * @Method("PUT")
     * @Template("CoipeaultCNMegapolisBundle:Stock:edit.html.twig")
     */
